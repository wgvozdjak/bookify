      ...
      <div class="shadow-xl flex bg-solid bg-white border-2 border-solid border-black w-[425px] rounded-3xl p-4 pb-5">
        ...
        <form v-else class="flex flex-col w-full gap-10" @submit.prevent="updateProfile">
          ...
          <div class="relative">
            ...
            <label for="email" class="cursor-text absolute left-0 -top-3.5 text-sky-500 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-sky-500 peer-focus:text-sm">Email</label>
          </div>
          <div class="relative">
            ...
            <label for="username" class="cursor-text absolute left-0 -top-3.5 text-sky-500 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-sky-500 peer-focus:text-sm">Username</label>
          </div>
          <div class="relative">
            ...
            <label for="website" class="cursor-text absolute left-0 -top-3.5 text-sky-500 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-sky-500 peer-focus:text-sm">Website</label>
          </div>
          ...
          <div class="flex flex-row w-full gap-4">
              ...
              <button class="py-2 basis-1/2 bg-sky-500 rounded-lg justify-center cursor-pointer hover:bg-sky-400 font-semibold transition" @click="signOut" :disabled="loading">
                Sign Out
              </button>
          </div>
        </form>

<template>
    <div class="flex flex-col items-center">
        ...
        <div class="flex flex-col basis-1/2">
            ...
            <div class="flex-1 flex flex-col books-read-table mt-2 border-solid border-2 border-black rounded-2xl border-separate border-spacing-0">
            <div class="tr">
        ...
        <div class="flex flex-col basis-1/2">
            ...
            <div>
            <img src="https://via.placeholder.com/500x350.png?text=placeholder+for+books+read+graph" />
            </div>
        </div>
        </div>
        ...
        <div class="w-full flex flex-row justify-between mb-8">
            <NuxtLink to="/" class="border-2 border-black border-solid rounded-2xl px-4 py-2 w-1/5 inline-block">
            data
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline mb-[2px]">
...
.books-read-table .td:not(.books-read-table .tr .td:last-child), .books-read-table .th:not(.books-read-table .tr .th:last-child) {
    @apply border-r-2;
    @apply border-black;
    @apply border-solid;
}
